...
//               />
//               <span className="font-bold text-lg">Newlus Pharma</span>
//             </Link>
...
//                     className="p-2 rounded-lg hover:bg-secondary-foreground/10 transition-colors"
//                   >
...
//               © 2024 Newlus Pharma. All rights reserved.
//             </p>
