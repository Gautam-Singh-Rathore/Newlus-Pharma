  ...
  return (
    <section id="about" className="py-16 sm:py-24 lg:py-32 bg-white overflow-hidden">
      <div className="max-w-[1536px] mx-auto px-6 md:px-12 xl:px-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-16 sm:mb-28">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#1B365D] leading-[1.15]">
              Bridging the gap between <span className="text-[#0A5C36]">quality manufacturing</span> and global healthcare.
            </h2>
            
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
              At Newlus Pharma, our core strength lies in identifying global healthcare needs and fulfilling them through uncompromising quality. We partner with world-class, WHO-GMP certified manufacturing facilities to bring premium pharmaceutical products to market.
            </p>
            
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
              We don't just distribute medicines; we build robust supply chains, ensure rigorous quality compliance, and create marketing solutions that make life-saving medications accessible worldwide.
            </p>

            <div className="flex items-center gap-4 pt-6 border-t border-gray-100">
              <div className="w-12 h-12 bg-[#0A5C36] rounded-full flex items-center justify-center text-white font-bold text-xl flex-shrink-0 shadow-lg shadow-[#0A5C36]/20">
                NP
              </div>
              <div>
                <p className="font-bold text-[#1B365D]">Committed to Excellence</p>
                <p className="text-sm text-gray-500">Global Standards, Local Care</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="absolute top-0 right-0 w-[85%] h-[85%] rounded-3xl overflow-hidden shadow-2xl z-10">
              <Image 
                src="/about-1.jpg" 
                alt="Pharmaceutical Supply Chain"
                fill
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-[#0A5C36]/20 to-transparent"></div>
            </div>
            ...
            <motion.div 
              ...
              className="absolute bottom-0 left-0 w-[60%] h-[55%] rounded-3xl overflow-hidden shadow-[-20px_20px_50px_rgba(0,0,0,0.15)] z-20 border-[6px] sm:border-[10px] border-white"
            >
              <Image 
                src="/about-2.jpg" 
                alt="Quality Assurance"
            ...
            <motion.div 
              ...
              className="absolute top-1/2 -translate-y-1/2 -left-4 sm:-left-8 z-30 bg-white p-4 rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.12)] border border-gray-50 flex items-center gap-3"
            >
              <div className="bg-[#8DC63F]/20 p-2 sm:p-3 rounded-xl text-[#0A5C36]">
                <Award className="w-6 h-6 sm:w-8 sm:h-8" />
              </div>
              <div>
                <p className="text-xl sm:text-2xl font-black text-[#1B365D]">100%</p>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-none">Quality Assured</p>
              </div>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8">
          {[
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.98 }} // Haptic-like feel for mobile
              className="bg-white rounded-2xl p-6 border border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgb(10,92,54,0.08)] transition-all duration-500 group"
            >
              <div className="w-12 h-12 bg-[#0A5C36]/5 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#0A5C36] group-hover:text-white transition-all duration-300">
                <stat.icon className="w-6 h-6 text-[#0A5C36] group-hover:text-white" />
              </div>
              <div className="text-3xl sm:text-4xl font-black text-[#1B365D] mb-1">
        ...
        {/* Core Pillars - Image Rich */}
        <div className="mt-20 sm:mt-32 pt-16 border-t border-gray-100">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            ...
            >
              <h3 className="text-3xl font-bold text-[#1B365D] mb-4">Our Core Pillars</h3>
              <p className="text-gray-600 leading-relaxed">
                Marketing pharmaceuticals requires a foundation of absolute trust, strict regulatory compliance, and a deep understanding of patient needs.
              </p>
            </motion.div>
            ...
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-8">
              {[
                { 
                  ...
                  img: "/pillar-1.jpg", 
                  icon: Target, 
                  desc: "We meticulously select manufacturing partners globally, ensuring every product meets international quality standards." 
                },
                { 
                  title: "Market Excellence", 
                  img: "/pillar-2.jpg", 
                  icon: Activity, 
                  desc: "Our robust distribution network ensures that high-quality medicines reach patients reliably and efficiently." 
                }
              ].map((pillar, i) => (
                <motion.div
                  key={i}
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    <Image src={pillar.img} alt={pillar.title} fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
                    <div className="absolute inset-0 bg-[#0A5C36]/20 group-hover:bg-transparent transition-colors duration-500"></div>
                  </div>
                  <div className="p-8 pt-10 relative">
                    <div className="absolute -top-7 left-8 w-14 h-14 bg-white rounded-2xl shadow-lg flex items-center justify-center group-hover:bg-[#0A5C36] group-hover:text-white transition-all duration-300">
                      <pillar.icon className="w-7 h-7 text-[#0A5C36] group-hover:text-white" />
                    </div>
                    <h4 className="text-xl font-bold text-[#1B365D] mb-3">{pillar.title}</h4>
