...
// //     content:
// //       'CardioCare Plus has transformed how we manage hypertension in our clinic. The efficacy and patient tolerance are exceptional.',
// //     rating: 5,
// //   },
// //   {
// //     name: 'James Chen',
// //     role: 'Patient',
// //     content:
// //       'After starting MetaBalance, my blood sugar levels are finally stable. I feel healthier and more energetic than I have in years.',
// //     rating: 5,
// //   },
// //   {
// //     name: 'Dr. Emma Rodriguez',
// //     role: 'Chief of Endocrinology, Regional Hospital',
// //     content:
// //       'The comprehensive support system from Newlus Pharma makes our job easier and our patients happier. Truly exceptional.',
// //     rating: 5,
// //   },
// //   {
...
// //     role: 'Patient',
// //     content:
// //       'WeightWise changed my life. Combined with the support program, I have finally achieved sustainable weight management.',
// //     rating: 5,
// //   },
// // ];
...
// //             Healthcare professionals and patients trust Newlus Pharma for real results.
// //           </p>
// //         </div>

// //         {/* Carousel */}
// //         <div className="relative bg-card rounded-2xl p-8 md:p-12 border border-border animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-100">
// //           {/* Testimonial Content */}
// //           <div className="min-h-64 flex flex-col justify-between">
// //             <div>
// //               <div className="flex gap-1 mb-6">
// //                 {Array.from({ length: testimonials[activeSlide].rating }).map(
// //                   (_, i) => (
// //                     <Star
// //                       key={i}
